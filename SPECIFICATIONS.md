...
| 5 | SIN Manfredonia (ex-Enichem)| vector | **MASE/ISPRA authoritative perimeter** — user-supplied shapefile at `data/raw/sin/SIN.shp` (EPSG:32633, 5 Manfredonia polygons covering public landfills + ex-Enichem + marine areas). OPEN-SIN-1 closed. OSM `industrial_areas` retained as a separate layer for context. | 2024 (SIN-5 perimeter mod. 02/12/2024) | MASE / ISPRA terms — source URL pending user confirmation |
